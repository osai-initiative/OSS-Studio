/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 4e83f6b1b3efa988254ef4e6f6d68529)
// Runtime types generated with workerd@1.20260730.1 2026-05-14 nodejs_compat
interface __BaseEnv_Env {
	STUDIO_FILES: R2Bucket;
	DB: D1Database;
	BROWSER: BrowserRun;
	CODEX_ADAPTER_URL: "https://osaii-codex-adapter.netlify.app";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CODEX_ADAPTER_URL" | "INVITE_SECRET" | "POOOLSIDE_API_KEY" | "GROQ_API_KEY">> {}
}
declare module "*.png" {
